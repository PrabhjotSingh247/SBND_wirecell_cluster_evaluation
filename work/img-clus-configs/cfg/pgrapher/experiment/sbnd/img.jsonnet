...
local img = {
    ...
    local chsel_pipes = 
      g.pnode({
        ...
        data: {
          //channels: std.range(5632 * anode.data.ident, 5632 * (anode.data.ident + 1) - 1), // commented 2025-05
          channels: std.range(5638 * anode.data.ident, 5638 * (anode.data.ident + 1) - 1), //added 2025-05
    ...
    solving :: function(anode, aname) {
        ...
        // ret: g.pipeline([bc, gd1, cs1, ld1, gd2, cs2, ld2, cs3, ld3, gc],"uboone-solving"),
         ret: g.pipeline([bc, gd1, cs1, ld1, gd2, cs2, ld2, cs3, ld3, gc],"uboone-solving"), //added Ewerton 2025-04
         //ret: g.pipeline([bc, cs1, ld1, gc],"simple-solving"), // original. Commented Ewerton 2025-04
    }.ret,
